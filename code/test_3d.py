...
parser.add_argument('--root_path', type=str, default='E:/data/LA', help='Name of Experiment')
...
path_1="SA+ECA_5"
snapshot_path = 'C:/Users/HP/Desktop/SETCNet10' + "/model/{}_{}_{}_labeled/{}".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum, path_1)
test_save_path = 'C:/Users/HP/Desktop/SETCNet10' + "/model/{}_{}_{}_labeled/{}_predictions/".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum, path_1)

num_classes = 2
if FLAGS.dataset_name == "LA":
    patch_size = (112, 112, 80)
    FLAGS.root_path = FLAGS.root_path
    with open(FLAGS.root_path + '/2018LA_Seg_Training Set/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = [FLAGS.root_path + "/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]

elif FLAGS.dataset_name == "Pancreas_CT":
    patch_size = (96, 96, 96)
    FLAGS.root_path = FLAGS.root_path + '/All_data'
    with open('E:/Pancreas_CT/All_data/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = ["E:/Pancreas_CT/All_data/" + "All_data" + item.replace('\n', '') + "_norm.h5" for item in image_list]
