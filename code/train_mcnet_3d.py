...
parser.add_argument('--root_path', type=str, default='E:/data/LA', help='Name of Dataset')
...
path_1="SA+ECA_5"
snapshot_path = 'C:/Users/HP/Desktop/SETCNet10' + "/model/{}_{}_{}_labeled/{}".format(args.dataset_name, args.exp, args.labelnum, path_1)

num_classes = 2
if args.dataset_name == "LA":
    patch_size = (112, 112, 80)
    args.root_path = args.root_path+'/2018LA_Seg_Training Set'
    args.max_samples = 80
